...
class VisitController(
    ...
    @Operation(summary = "방문 기록 등록", description = "특정 라멘집에서 먹은 메뉴와 평점을 기록합니다.")
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "201",
    ...
    @Operation(summary = "방문 기록 목록 조회", description = "전체 방문 기록을 최신 방문일 순으로 조회합니다.")
    @ApiResponse(
        responseCode = "200",
    ...
    @Operation(summary = "방문 기록 상세 조회", description = "방문 기록 ID로 상세 정보를 조회합니다.")
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
    ...
    @Operation(summary = "방문 기록 수정", description = "방문일, 메뉴, 평점, 메모를 수정합니다.")
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
    ...
    @Operation(summary = "라멘집별 방문 기록 조회", description = "특정 라멘집에 연결된 방문 기록을 조회합니다.")
    @ApiResponses(
        value = [
            ApiResponse(
                responseCode = "200",
